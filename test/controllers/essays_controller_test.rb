...
class EssaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create essay" do
    assert_difference("Essay.count") do
      post essays_url, params: { essay: { note1: @essay.note1, note2: @essay.note2, prompt_id: @essay.prompt_id, situation: @essay.situation, task: @essay.task } }
    end
  ...
  test "should update essay" do
    patch essay_url(@essay), params: { essay: { note1: @essay.note1, note2: @essay.note2, prompt_id: @essay.prompt_id, situation: @essay.situation, task: @essay.task } }
